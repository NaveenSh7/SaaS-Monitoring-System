   ...
   {/* Key Metrics Row */}
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-emerald-500">
                    ...
                    {data.HoursData[0].status ==='up' ? data.HoursData[0].total_hours : data.HoursData[1].total_hours}
                    </div>
              ...
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-blue-500">{data.LatencyData}ms</div>
              ...
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-purple-500">{data.TrafficData}</div>
                  <p className="text-xs text-zinc-400">since registerd on our system.</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-red-500">
                   {data.HoursData[0].status==='down' ? data.HoursData[0].total_hours :data.HoursData[1].total_hours }
                    </div>
                  <p className="text-xs text-zinc-400">since registerd on our system.</p>
                </CardContent>
              </Card>
